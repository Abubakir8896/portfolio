...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    e.preventDefault();
    emailjs
      .sendForm("service_5mb6uw6", "template_iuv4t1b", form.current, {
        publicKey: "XwnnNBfGt68HwMzP2",
      })
      .then(
        () => {
  ...
  return (
    <div className="contact-page min-h-screen bg-[#0F0F0F] p-8 lg:p-12">
      ...
      <div className="contact-body">
          ...
          <ul className="grid xl:grid-cols-2 justify-center w-full gap-8 px-4 lg:px-16">
                ...
                <ul className="flex items-center gap-x-2">
                  <li>
                    <a
                      ...
                      rel="noreferrer"
                      target="_blank"
                      className="text-[22px] transition-colors hover:text-yellow-500"
                    >
                  ...
                  <li>
                    <a
                      href="https://www.linkedin.com/in/zikirovabubakir"
                      rel="noreferrer"
                      target="_blank"
                      className="text-[22px] transition-colors hover:text-yellow-500"
                    >
                  ...
                  <li>
                    <a
                      href="https://instagram.com/__zikirov__08__?igshid=OGQ5ZDc2ODk2ZA=="
                      rel="noreferrer"
                      target="_blank"
                      className="text-[22px] transition-colors hover:text-yellow-500"
                    >
                  ...
                  <li>
                    <a
                      href="https://t.me/ZikirovAbubakir"
                      rel="noreferrer"
                      target="_blank"
                      className="text-[22px] transition-colors hover:text-yellow-500"
                    >
            ...
            <li className="flex gap-5 items-center bg-[#2C3333] py-2 px-4 rounded-md">
              ...
              <div className="location-body">
                ...
                <p className="text-white">Abubakir.zikirov8896@gmail.com</p>
              </div>
            </li>
            <li className="flex gap-5 items-center bg-[#2C3333] py-2 px-4 rounded-md">
              <div className="location flex items-center justify-center rounded-full text-[24px] w-14 h-14 bg-[#2E4F4F]">
              ...
              <div className="location-body">
                ...
                <p className="text-white">+998 93 120 88 96</p>
              </div>
            </li>
          </ul>
        </div>
        ...
        <form
          className="flex flex-col gap-4 w-full px-4 lg:px-16"
          onSubmit={sendEmail}
          ref={form}
        >
