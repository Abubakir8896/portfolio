  ...
  return (
    <div className="home-page min-h-screen bg-[#0F0F0F] p-12">
      ...
      <p className="text-white font-mono text-[16px] mb-16">
        ...
        Software Engineering. <br /> I have completed the FullStack developer course at
        Najot Ta&apos;lim and obtained a certification.
        <br /> Furthermore, I have completed courses such as Learning Javascript, HTML CSS in Depth.
        <br /> With expertise in JavaScript, Node.js,
        ...
        GraphQL for efficient data management. <br /> My language
        proficiency includes English (B1 level), Russian (C1 level), 
        and Uzbek (Native). <br /> I am eager to apply my knowledge and
      ...
      <ul className="about-me list-none max-w-[700px] grid md:grid-cols-2  gap-3 mb-8">
        ...
        <li>
          ...
          Abubakir.Zikirov8896@gamil.com
        </li>
        <li>
          <i className="fa-solid fa-angle-right text-[#dc6b24] mr-1"></i>
          Freelance: Available
      ...
      <div className="use mt-11  mb-20">
        ...
        <div className="frontend mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-2">
            ...
            <li className="flex flex-col gap-2">
              <div className="skill-body flex justify-between pe-2 items-center">
                <p className="text-white">Vuex JS</p>
                <i className="fa-regular fa-circle-check"></i>
              </div>
              <span className="block h-1 rounded-sm bg-[#dc6b24]"></span>
            </li>
            <li className="flex flex-col gap-2">
              <div className="skill-body flex justify-between pe-2 items-center">
                <p className="text-white">Pinia</p>
                <i className="fa-regular fa-circle-check"></i>
              </div>
              <span className="block h-1 rounded-sm bg-[#dc6b24]"></span>
            </li>
